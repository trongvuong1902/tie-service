...
abstract class $AddressComponentCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'longText') String longName,
      @JsonKey(name: 'shortText') String shortName,
      List<String> types});
}
...
class _$AddressComponentImpl implements _AddressComponent {
  _$AddressComponentImpl(
      {@JsonKey(name: 'longText') required this.longName,
      @JsonKey(name: 'shortText') required this.shortName,
...
abstract class _AddressComponent implements AddressComponent {
  factory _AddressComponent(
      {@JsonKey(name: 'longText') required final String longName,
      @JsonKey(name: 'shortText') required final String shortName,
